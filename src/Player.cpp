...
{
    // si le joueur est sur la tuile mais pas en train de sauter
    // alors la hauteur du joueur diminue 

    // A TESTER AILLEURS : si la hauteur du joueur diminue sous un certain seuil, alors c perdu 
}
